...
ARCH		?= arm64
CROSS_COMPILE	?= /home/kristof/kernels/linaro/bin/aarch64-linux-gnu-
...
KBUILD_CFLAGS	+= -mcpu=cortex-a73.cortex-a53+crc+crypto -mtune=cortex-a73.cortex-a53 -fno-store-merging
